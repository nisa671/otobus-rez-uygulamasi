      ...
      <?php if(isset($succ)) {?>
        ...
        <div class="card-body">
          ...
          <form method ="POST" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Araç Kayıt Numarası</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_reg_no">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Araç Koltuk Sayısı</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="v_pass_no">
            </div>
            <div class="form-group">
              <label for="exampleFormControlSelect1">Şöfor</label>
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Araç Kategorisi</label>
            ...
            <div class="form-group">
              <label for="exampleFormControlSelect1">Araç Durumu</label>
            ...
            <button type="submit" name="add_veh" class="btn btn-success">Araç Ekle</button>
          </form>
          <!-- End Form-->
        </div>
      </div>
