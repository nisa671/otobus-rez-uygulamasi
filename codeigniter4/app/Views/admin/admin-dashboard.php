...
<head>
  ...
  <meta name="description" content="Umuttepe Turizm">
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $user;?></span> Kullanıcılar</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="admin-view-user.php">
                <span class="float-left">Detayları Gör</span>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $driver;?></span> Şöforler</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $vehicle;?></span> Araçlar</div>
              </div>
            ...
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <?php
                  ...
                  $stmt->close();
                ?>
                <div class="mr-5"><span class="badge badge-danger"><?php echo $book;?></span> Rezervasyonlar</div>
              </div>
