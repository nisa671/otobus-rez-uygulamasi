            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="booking.php?id=<?php echo $row['id']; ?>&date=<?php echo $date; ?>" class="btn btn-sm btn-outline-primary shadow-none"><span
                                class="d-block d-sm-none d-lg-block">Seçilen Koltuklar</span></a>
                </td>
            </tr>
            <?php
        }
...
include 'include/footer.php';
    ...
    <div class="container bg-light shadow-md rounded py-4">
        <div class="mx-3 mb-3 text-center">
            <h4 class="">Tüm Otobüsler <?php echo $date ?></h4>
        ...
        <table class="table text-xl-center">
            ...
            while ($row = mysqli_fetch_assoc($a_data)) {
                ...
                <tr>
                    ...
                    <td>
                        <span class="d-inline-block d-sm-block text-dark mb-sm-1"><?php echo $row['price']; ?>TL</span>
    ...
    <div class="container bg-light shadow-md rounded py-4">
        <div class="mx-3 mb-3 text-center">
            <h4 class="">Tüm Seferler</h4>
            <h5>Sefer İçin Tarih Seçin</h5>
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                <input name="date" id="datepicker" type="text" class="form-control" required="" placeholder="Kalkış Tarihi">
                <input type="hidden" name="from" value="From">
                <input type="hidden" name="to" value="To">
                <button class="btn btn-primary btn-block" name="submit-search">Araç</button>
            </form>
        </div>
        <table class="table text-xl-center">
