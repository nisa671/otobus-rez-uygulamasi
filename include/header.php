    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <h6><a class="nav-link " href="buslist.php">Güzergah</a></h6>
                </li>
                <li class="nav-item">
                    <h6><a class="nav-link " href="admin/index.php">Admin Girişi</a></h6>
                </li>
                <?php
                if (!isset($_SESSION['name'])) {
                    ?>
                    <li class="nav-item">
                        <h6><a class="nav-link " href="login.php">Giriş Yap</a>
                    </li>
                    <li class="nav-item">
                        <h6><a class="nav-link " href="reg.php">Kayıt Ol</a>
                        </h6>
                    </li>
                    <?php
                }
